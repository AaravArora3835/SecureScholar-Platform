// =========================================================
// SecureScholar Adaptive Quiz Engine (v1.0)
// Author: Aarav Arora — 2025-10-20
// Description: Adjusts quiz difficulty dynamically based on user performance.
// =========================================================
...
class AdaptiveQuiz {
  ...
  private consecutiveRight: number;
  private consecutiveWrong: number;
  ...
  evaluatePerformance(isCorrect: boolean): void {
    if (isCorrect) {
  ...
  private offerHint(): void {
    ...
    btn?.addEventListener('click', () => hintBox.remove());
  }
}
